...
internal class RedBlackTreeTest {
    ...
    @Test
    fun insertNormal() {//38sec
        val arr=Array(10000001,{ 0 })
        for (i in 1..10000000) {
            val key = Random().nextInt(9999999) + 1
    ...
    @Test
    fun deleteRootFullTree() {//33sec
        var key:Int=0
        for (i in 1..10000000) {
            key = Random().nextInt(9999999) + 1
            RBTree.insert(key, key)
        }
    ...
    @Test
    fun deleteNormal() {//1min 28sec
        var key:Int
        val arr=Array(100001,{ 0 })
        for (i in 1..100000) {
            key=Random().nextInt(99999)+1
            RBTree.insert(key, key)
            arr[key]++
        ...
        for (i in 1..100000) if (arr[i]>0) assertTrue(RBTree.searchNode(i) in RBTree)
        else assertFalse(RBTree.searchNode(i) in RBTree)
    }

    @Test
    fun deleteNonexistentKey() {//4min 15sec
        var key:Int
        val arr=Array(100001,{ 0 })
        for (i in 1..50000) {
            key=Random().nextInt(49999)+1
            RBTree.insert(key, key)
            arr[key]++
        }
    ...
    @Test
    fun rootColorAfterDelete() {//1min 8sec
        var key:Int
        val arr=Array(10000001,{ 0 })
        for (i in 1..10000000) {
            key=Random().nextInt(9999999)+1
